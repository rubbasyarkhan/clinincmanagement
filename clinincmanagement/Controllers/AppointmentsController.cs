...
namespace clinincmanagement.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var clinicManagementDbContext = _context.Appointments.Include(a => a.Doctor).Include(a => a.Patient);
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,PatientId,DoctorId,AppointmentDate,Status,Notes")] Appointment appointment)
        {
            ...
            ViewData["DoctorId"] = new SelectList(_context.Users, "UserId", "UserId", appointment.DoctorId);
